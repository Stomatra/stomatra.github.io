  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 3fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是 Stoma & Yuki Rin</span>
        <span class="text3"></span>
      </div>
      <!-- 技能 -->
      <div class="about-item skills">
        <span class="tip">技能</span>
        <span class="title2">我不会的东西</span>
    ...
    <div class="about-content compact-row" style="grid-template-columns: 2fr 2fr">
      <!-- 座右铭 -->
      <div class="about-item">
        <span class="tip">目标</span>
        <span class="title1" style="margin-top: 20px">跨越虚无，</span>
        <span class="title2">追问永恒。</span>
      </div>
      <div
      ...
      >
        <div class="image-content">
          ...
          <span class="title2">纯音乐 ACG artcore 日系摇滚</span>
        </div>
      </div>
    </div>
    <div class="about-content" style="grid-template-columns: 2fr 2fr">
      ...
      <div class="about-item child">
        ...
        >
          <span class="position">我现在住在 <strong>中国，上海市</strong></span>
        </div>
